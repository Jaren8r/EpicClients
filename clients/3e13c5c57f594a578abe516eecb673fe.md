...
Status: Enabled<br>
Client ID: 3e13c5c57f594a578abe516eecb673fe<br>
Client Secret: 530e316c337e409893c55ec44f22cd62<br>
EOS: Yes (epicId)<br>
...
| community-management-service:authentication:epic-first-party-access | READ |
...
| Resource | Action |
| -------- | ------ |
| ArcadeWeapon:profile:{accountId}:commands | READ |
| BabyCorgi:profile:{accountId}:commands | READ |
| Delilah:status:{accountId} | READ |
...
| arcadeweapon:profile:{accountId}:* | READ |
...
| discovery:{accountId}:links:vote | CREATE READ DELETE |
...
| emporium:library:public:{accountId}:assets | READ |
| emporium:library:public:{accountId}:offers | READ |
| entitlement | READ |
...
| fortnite:cloudstorage:user:{accountId}:ClientSettingsJioCloud.sav | ALL |
| fortnite:cloudstorage:user:{accountId}:ClientSettingsJioCloudMobile.sav | ALL |
...
| vkasmr:moderation:violations | READ |
