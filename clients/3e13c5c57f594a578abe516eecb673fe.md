...
Grant Types: `authorization_code`, `client_credentials`, `device_auth`, `exchange_code`, `external_auth`, `refresh_token`<br>
...
| presence:_:{accountId}:settings:invisibility | READ UPDATE |
